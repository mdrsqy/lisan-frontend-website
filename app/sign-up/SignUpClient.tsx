...
export default function SignUpClient() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0A0F1C] text-slate-100 font-sans selection:bg-blue-500/30 selection:text-blue-100 overflow-hidden flex items-center justify-center py-10">
        ...
        <GlassCard className="p-8 md:p-12 rounded-[2rem]">
          <div className="mb-10 flex flex-col items-center text-center">
            ...
            <p className="text-slate-400 text-sm max-w-md">
              Bergabunglah dengan <span className="font-semibold text-blue-400">Lisan</span> untuk memulai perjalanan inklusif Anda
            </p>
          </div>
          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-4 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:scale-[1.01] active:scale-95 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm tracking-wide"
              >
